define({ "api": [
  ...
  {
    "type": "get",
    "url": "/promotions/actions/count-products",
    "title": "Lấy tổng sản phẩm khuyến mãi",
    "name": "Lấy_tổng_khuyến_mãi",
    "group": "Khuyến_mãi",
    "version": "1.0.0",
    "description": "<p>Lấy tổng sản phẩm đang được khuyến mãi</p>",
    "parameter": {
      "fields": {
        "Parameter": [
          {
            ...
            "optional": true,
            "field": "product_group_id",
            "description": "<p><mark>ID nhóm sản phẩm <br><code>-1:</code> Tính tổng toàn bộ sản phẩm khuyến mãi</mark></p>"
          }
        ]
      },
      "examples": [
        {
          "title": "URL request:",
          "content": "{host}/api/v1.0/promotions/actions/count-products?product_group_id=1,2,3",
          "type": "json"
        }
      ]
    },
      ...
      "fields": {
        "Success 200": [
          ...
          },
          {
            ...
            "type": "Number",
            "optional": false,
            "field": "O.data.total_product",
            "description": "<p>Tổng số sản phẩm</p>"
          }
        ]
      },
      "examples": [
  ...
  {
    "type": "post",
    "url": "/customers/actions/order-giftcards",
    "title": "Đặt mua phiếu mua hàng",
      ...
      "fields": {
        "Body": [
          ...
          },
          {
            ...
            "optional": false,
            "field": "phone",
            "description": "<p>Số điện thoại nhận mã sử dụng phiếu mua hàng</p>"
          },
          {
            "group": "Body",
            "type": "Number",
  ...
  {
    "type": "get",
    "url": "/customers/<customer_id>/giftcards",
    ...
    "parameter": {
      ...
      "examples": [
        {
          "title": "URL request:",
          "content": "{host}/api/v1.0/customers/10/giftcards?sort=-end_time",
          "type": "json"
        }
      ]
    },
      ...
      "fields": {
        "Success 200": [
          ...
          },
          {
            ...
            "optional": false,
            "field": "O.data",
            "description": "<p>Danh sách thông tin phiếu mua hàng</p>"
          },
          {
            "group": "Success 200",
            "type": "Number",
            "optional": false,
            "field": "O.data.gift_card_id",
            "description": "<p>ID phiếu mua hàng khách hàng đang sở hữu</p>"
          },
          {
            "group": "Success 200",
            "type": "String",
            "optional": false,
            "field": "O.data.gift_card_code",
            "description": "<p>Mã sử dụng của phiếu mua hàng</p>"
          },
          {
            "group": "Success 200",
            "type": "Date",
            ...
            "description": "<p>Thời hạn phiếu mua hàng của khách hàng</p>"
          },
          {
            "group": "Success 200",
            "type": "Number",
            "optional": false,
            "field": "O.data.value",
            "description": "<p>Giá trị của phiếu mua hàng</p>"
          }
        ]
      },
      "examples": [
  ...
  },
  {
    "type": "get",
    "url": "/articles",
    "title": "Lấy danh sách bài viết",
    "name": "Lấy_danh_sách_bài_viết",
    "group": "Mẹo_vặt",
    "version": "1.0.0",
    "description": "<p>Hiển thị danh sách các bài viết (mẹo vặt)</p>",
    "parameter": {
      "fields": {
        "Body": [
          {
  ...
  },
  {
    ...
    "title": "Lấy danh sách bài viết khách hàng đã đăng",
      ...
      "fields": {
        "Success 200": [
          ...
          },
          {
            ...
            "type": "String",
            "optional": false,
            "field": "Object.data.article.content",
            "description": "<p>nội dung</p>"
          },
          {
            "group": "Success 200",
          ...
          },
          {
            ...
            "type": "String",
            "optional": false,
            "field": "Object.data.article.status",
            "description": "<p>trạng thái bài viết</p>    <ul>         <li><code>0:</code>Đang chờ duyệt</li>         <li><code>1:</code>Đã bị từ chối</li>         <li><code>2:</code>Khách hàng đã xóa</li>         <li><code>3:</code>Đã được duyệt</li>     </ul>"
          }
        ]
      },
      "examples": [
      ...
      "fields": {
        "Parameter": [
          ...
          },
          {
            ...
            "optional": true,
            "field": "parent_id",
            "description": "<p><mark>ID nhóm sản phẩm cha <br><code>parent_id=0:</code> Lấy nhóm sản phẩm gốc</mark></p>"
          },
          {
            "group": "Parameter",
            "type": "Number",
  ...
  },
  {
    ...
    "parameter": {
        ...
        "Parameter": [
          {
            ...
            "optional": false,
            "field": "parent_id",
            "description": "<p><mark>ID khu vực cha <br><code>parent_id=0:</code> Lấy khu vực cấp tỉnh</mark></p>"
          },
          {
            "group": "Parameter",
            "type": "String",
      ...
      "examples": [
        {
          "title": "URL request:",
          "content": "{host}/api/v1.0/sectors?parent_id=0&sort=+id",
          "type": "json"
        }
      ]
    },
