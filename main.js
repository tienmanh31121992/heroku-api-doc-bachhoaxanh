require.config({
    paths: {
        bootstrap: './my-venor/bootstrap.min',
        diffMatchPatch: './my-venor/diff_match_patch.min',
        handlebars: './my-venor/handlebars.min',
        handlebarsExtended: './utils/handlebars_helper',
        jquery: './my-venor/jquery.min',
        locales: './locales/locale',
        lodash: './my-venor/lodash.custom.min',
        pathToRegexp: './my-venor/path-to-regexp/index',
        prismjs: './my-venor/prism',
        semver: './my-venor/semver.min',
        utilsSampleRequest: './utils/send_sample_request',
        webfontloader: './my-venor/webfontloader',
        list: './my-venor/list.min',
        apiData: './api_data',
