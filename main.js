require.config({
    paths: {
        bootstrap: './vendor1/bootstrap.min',
        diffMatchPatch: './vendor1/diff_match_patch.min',
        handlebars: './vendor1/handlebars.min',
        handlebarsExtended: './utils/handlebars_helper',
        jquery: './vendor1/jquery.min',
        locales: './locales/locale',
        lodash: './vendor1/lodash.custom.min',
        pathToRegexp: './vendor1/path-to-regexp/index',
        prismjs: './vendor1/prism',
        semver: './vendor1/semver.min',
        utilsSampleRequest: './utils/send_sample_request',
        webfontloader: './vendor1/webfontloader',
        list: './vendor1/list.min',
        apiData: './api_data',
