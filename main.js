require.config({
    paths: {
        bootstrap: './my-vendor/bootstrap.min',
        diffMatchPatch: './my-vendor/diff_match_patch.min',
        handlebars: './my-vendor/handlebars.min',
        handlebarsExtended: './utils/handlebars_helper',
        jquery: './my-vendor/jquery.min',
        locales: './locales/locale',
        lodash: './my-vendor/lodash.custom.min',
        pathToRegexp: './my-vendor/path-to-regexp/index',
        prismjs: './my-vendor/prism',
        semver: './my-vendor/semver.min',
        utilsSampleRequest: './utils/send_sample_request',
        webfontloader: './my-vendor/webfontloader',
        list: './my-vendor/list.min',
        apiData: './api_data',
