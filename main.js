require.config({
    paths: {
        bootstrap: './vendor.ignore/bootstrap.min',
        diffMatchPatch: './vendor.ignore/diff_match_patch.min',
        handlebars: './vendor.ignore/handlebars.min',
        handlebarsExtended: './utils/handlebars_helper',
        jquery: './vendor.ignore/jquery.min',
        locales: './locales/locale',
        lodash: './vendor.ignore/lodash.custom.min',
        pathToRegexp: './vendor.ignore/path-to-regexp/index',
        prismjs: './vendor.ignore/prism',
        semver: './vendor.ignore/semver.min',
        utilsSampleRequest: './utils/send_sample_request',
        webfontloader: './vendor.ignore/webfontloader',
        list: './vendor.ignore/list.min',
        apiData: './api_data',
